  ...
  return (
    <section className="flex flex-col items-center justify-center py-16">
      <div className="glass-container max-w-3xl text-center">
        ...
        <p className="mb-4">
          Skilled and Experienced in Java, Spring Boot, Hibernate, Kafka, Python, Django, Node.js, JavaScript, Next.js MySQL, PostgreSQL, MongoDB, Git, Docker, Linux and more.
        </p>
        <p className="mb-6">
